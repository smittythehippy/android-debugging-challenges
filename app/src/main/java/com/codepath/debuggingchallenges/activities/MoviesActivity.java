...
public class MoviesActivity extends AppCompatActivity {
    ...
    private static final String API_KEY = "https://api.themoviedb.org/3/movie/now_playing?api_key=a07e22bc18f5cb106bfe4cc1f83ad8ed";
    ...
    private void fetchMovies() {
        ...
        client.get(API_KEY, null, new JsonHttpResponseHandler() {
            @Override
